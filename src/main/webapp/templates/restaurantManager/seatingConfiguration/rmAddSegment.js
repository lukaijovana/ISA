...
(function() {
    ...
    var RMAddSegmentController = function ($scope, $timeout, SegmentService, AuthService, RestaurantManagerService, TableService) {
    	if (!AuthService.IsAuthorized("rmanager"))
		{
	    	...
	    	$scope.addRegion = function(odabraniStolovi) {
				...
				SegmentService.AddSegment($scope.region);
			}
    ...
    app.controller("RMAddSegmentController", RMAddSegmentController);
})();