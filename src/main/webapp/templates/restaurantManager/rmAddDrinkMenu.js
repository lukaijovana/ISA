...
(function() {
    ...
    var RMAddDrinkMenuController = function ($scope, DrinkMenuService, DrinkService, AuthService, RestaurantManagerService) {
    	if (!AuthService.IsAuthorized("rmanager"))
		{
    		...
    		$scope.addMenu = function() {
    			...
    			var menu = {};
    			menu.picaId = idOdabranihJela;
    			menu.dateFrom = from;
    			menu.dateTo = to;
    			menu.restaurantId = $scope.restaurantId;
    			DrinkMenuService.AddMenu(menu);
    		}
    		DrinkService.ViewAllDrinks().then(function(data){
    			$scope.items = data;
    		});
    ...
    app.controller("RMAddDrinkMenuController", RMAddDrinkMenuController);
})();